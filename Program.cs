        ...
        private static void rightFeedback()
        {
            ...
            switch (num)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Console.WriteLine("Awesome! You're on fire!");
                    break;
                case 4:
                    Console.WriteLine("Fantastic! Keep it up!");
                    break;
                case 5:
                    Console.WriteLine("Perfect! You're a math whiz!");
                    break;
                case 6:
                    Console.WriteLine("Brilliant! You're mastering this!");
                    break;
                case 7:
                    Console.WriteLine("Excellent! You're acing these problems!");
                    break;
                default:
                    Console.WriteLine("Correct! Great job!");
                    break;
